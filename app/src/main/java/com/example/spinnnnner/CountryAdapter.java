    ...
    private View initView(int position,  View convertView,  ViewGroup parent){
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(
                    R.layout.country_spinneer_row,parent,false
            );
        }
        ImageView imageViewFlag = convertView.findViewById(R.id.egy);
        TextView textViewName = convertView.findViewById(R.id.tegy);
